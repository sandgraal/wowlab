...
# Lab (local-only track)

Spec: `docs/LAB_PLAN.md`. Formats: `docs/LAB_FORMATS.md`. Paths: `docs/LAB_FILE_MAP.md`. ADR-0019 to ADR-0024. These extend `AGENTS.md`; they never override it.
...
- **Boundary (ADR-0019).** `wowlab_core` never imports `bronze_api`; `api/`, `worker/` and `agent/` never import or invoke Lab code.
